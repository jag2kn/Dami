...
ToroParticulasState::ToroParticulasState(StateMachineApp* app) : State(app){	
}

void ToroParticulasState::setup(){
...
void ToroParticulasState::update(){
	delta = (ofGetElapsedTimeMillis()%1000)/1000.0;
}

void ToroParticulasState::draw(){
...
string ToroParticulasState::getStateName(){
	return "ToroParticulasState";
}

void ToroParticulasState::keyPressed(int key){
}

void ToroParticulasState::keyReleased(int key){
...
void ToroParticulasState::mouseMoved(int x, int y ){
}

void ToroParticulasState::mousePressed(int x, int y, int button){
}

void ToroParticulasState::mouseReleased(int x, int y, int button){
}

void ToroParticulasState::mouseDragged(int x, int y, int button){
}

void ToroParticulasState::in(){
}

void ToroParticulasState::out(){
}

void ToroParticulasState::exit(){
	delete torus;
}
